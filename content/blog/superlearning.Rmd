...
- The motivation for this type of "ensembling" is that **a mix of multiple algorithms may be more optimal for a given data set than any single algorithm**. For example, a tree based model averaged with a linear model (e.g. random forests and LASSO) could smooth or regularize some of the edges and improve predictive performance.
