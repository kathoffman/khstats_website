...
stroke_override <- c(1,1,1,1,1.5) # order matches `cols`:severe, intubation (yes/no), steroids, death
size_override <- c(2.5,2.5,2.5,2,2) # order matches `cols`:severe, intubation (yes/no), steroids, death
