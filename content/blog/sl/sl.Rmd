...
Other `R` packages besides `SuperLearner` that can be used to implement the superlearner algorithm include `sl3` (an update to the older `Superlearner` package), `ml3`, `h2o`, and `caretEnsemble`. I wrote a brief tutorial on using `sl3` for an NYC R-Ladies meetup [here](www.khstats.com/blog/sl3_demo/sl).
