...
>To predict on new data:<br><br>1.Use the fits from each base learner to obtain base learner predictions for the new observation(s) (similar to Step 7).<br><br>2. Plug those base learner predictions into the metalearner fit (similar to Step 8).
