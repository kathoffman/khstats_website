...
In this post I will walk through the Superlearner algorithm for prediction. There is a step-by-step demonstration with `R` code of how to build a superlearning algorithm as well as demo code at the end for using the `SuperLearner` package.
...
![](/img/Superlearning.jpg)

A high-quality version of this visual guide exists on my [Github](https://github.com/hoffmakl/CI-visual-guides/blob/master/visual-guides/Superlearner.pdf). It's ready-to-print on an 8.5x11" paper, should you wish to decorate your desk area with it, post-pandemic.
