...
For simplicity I'll show the concept of superlearning using only four variables (AKA features or predictors) to predict a continuous outcome. We'll call these variables $W_1$, $W_2$, $W_3$ and $W_4$. 
<html>
<body>
...
1. **Learner a**: $Y=\beta_0 + \beta_1 W_2 + \beta_2 W_4$

2. **Learner b**: $Y=\beta_0 + \beta_1 W_1 + \beta_2 W_2 + \beta_3 W_1 W_3 + \beta_4 sin(W_4)$

3. **Learner c**: $Y=\beta_0 + \beta_1 W_1 + \beta_2 W_2 + \beta_3 W_3 + \beta_4 W_1 W_2 + \beta_5 W_1 W_3 + \beta_6 W_2 W_3 + \beta_7 W_1 W_2 W_3$
