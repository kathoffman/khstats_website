...
In this tutorial I will go through the algorithm one step at a time using a simulated data set. It is a modified version of Maya Peterson and Laura Balzar's [R Lab 3: Superlearning](https://www.ucbbiostat.com/labs), which you can try out if you want more practice.
...
Okay, so we have a cross-validated prediction for every observation in the data set. Now we want to merge those CV predictions back into our main data set...
