...
I'm going to go through the algorithm one step at a time using a simulated data set. It is a modified version of Maya Peterson and Laura Balzar's [R Lab 3: Superlearning](https://www.ucbbiostat.com/labs) which you can try out if you want more practice.
...
cv_sq_error %>% select(id, contains("sqrd_error")) %>% head() %>% kable(digits=2, caption = "Squared error of each base learner") 
```
