...
For simplicity I'll show the concept of superlearning using only four variables (AKA features or predictors) to predict a continuous outcome. We'll call these variables $X_1$, $X_2$, $X_3$ and $X_4$. 
<html>
<body>
...
To start this example, let's simulate a continuous outcome, `y`, and those four variables for prediction, `x1`, `x2`, `x3`, and `x4`. 
