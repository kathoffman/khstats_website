...
You can specify the metalearner with the `method` argument. The default is [non-negative least squares](#appendix). For more information on the `SuperLearner` package, check out this [vignette](https://cran.r-project.org/web/packages/SuperLearner/vignettes/Guide-to-SuperLearner.html).
