---
title: "An Illustrated Guide to Modified Treatment Policies, Pt. 1: Introduction and Motivation"
...
>The first of a multi-post series to help applied statisticians and data scientists understand and implement Modified Treatment Policies (MTPs).

<!-- This section provides an introduction to MTPs, motivation for adding them to your data analysis toolbox, and several examples of research questions that can be answered using MTPs. -->
...
This post provides an **introduction to MTPs**, **motivation** for adding them to your **data analysis toolbox**, and several **examples of research questions** that can be answered using MTPs. It is organized as follows:
 
<!-- Although it is written for an audience of applied statisticians and data scientists, I hope the introductory post is useful to those looking for a conceptual understanding of MTPs. -->
...
<html>
   ...
   <body>
      <a href="">
         <img alt="" src="/img/universe_comic.jpg"
               style="float:right; padding-left:30px;" width=50%">
      </a>
   </body>
</html>
...
<html>
   ...
   <body>
      <a href="">
         <img alt="" src="/img/positivity_comic.jpg"
...
## One possible solution to these problems is Dynamic Treatment Policies.

**Dynamic treatment policies** ask what would have happened in a hypothetical world where **exposure is assigned based on each observation’s covariate history**.
...
We can try getting around these issues by evaluating a dynamic intervention that depends on baseline characteristics of the person or environment. For example, "*if a person lives in an industrial area, make their AQI exposure 75, and if a person lives in a residential area, make their AQI exposure 25.*"
...
<!--    <body> -->
<!--       <a href=""> -->
<!--          <img alt="" src="/img/climbing_dag_comic.jpg" -->
...
## An important note on longitudinal studies 
...
- [*Estimation of the effect of interventions that modify the received treatment*](https://pubmed.ncbi.nlm.nih.gov/23913589/) by Sebastian Haneuse and Andrea Rotnitzky
