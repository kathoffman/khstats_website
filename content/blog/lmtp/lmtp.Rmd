...
This post provides an **introduction to Modified Treatment Policies (MTPs)**, **motivation** for adding them to your **data analysis toolbox**, and several **examples of research questions** that can be answered using MTPs. It is organized as follows:
...
Although this series is for an audience of applied statisticians and data scientists, I hope the introductory post is useful to those looking for a conceptual understanding of MTPs.
...
<html>
   ...
   <body>
      <a href="">
         <img alt="" src="/img/dynamic_graph.jpg"
               style="" width=100%" >
      </a>
      <figcaption>An example of a naturally observed exposure of AQI in the US (left) and what it would look like under a hypothetical dynamic intervention in which all urban counties have an AQI of 40 and rural counties have an AQI of 20 (right).</figcaption>
   </body>
</html>
...
<html>
   ...
   <body>
      <a href="">
         <img alt="" src="/img/modified_graph.jpg"
               style="" width=100%" >
      </a>
      <figcaption>An example of a naturally observed exposure of AQI in the US (left) and what it would look like under a hypothetical modified treatment policy in which all observations have an AQI exposure 20% less than what was actually observed (right).</figcaption>
   </body>
</html>
