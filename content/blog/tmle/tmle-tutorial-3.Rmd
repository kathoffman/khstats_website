---
title: "WTF is TMLE? A Visual Guide & Introductory R Tutorial on Targeted Minimum Loss-based Estimation"
...
- These estimates can come from regressions we commonly classify as machine learning (ML), but the overall estimate of the treatment effect will still have **valid confidence intervals**, unlike the estimates normally obtained from ML
