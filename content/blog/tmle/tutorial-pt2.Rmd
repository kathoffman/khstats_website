...
This last piece is super important for me, because I remember best when I associate an image with what I've learned. If the graphics are also useful to you, it may be helpful to open this [corresponding key](https://khstats.com/blog/tmle/visual-key) in another browser or print the [visual guide](https://github.com/hoffmakl/causal-inference-visual-guides) for reference.
...
Under causal assumptions, this could be *identifiable* as the Average Treatment Effect (ATE). I won't go through the identification process here (see [*Part III, References*](www.khstats.com/blog/tmle/tutorial-pt3/#resources-to-learn-more)), but since TMLE is often used for causal inference, let's pretend for this example that we previously met causal assumptions and call our statistical estimand, $\Psi$, the ATE.
...
The point of this step is to solve an *estimating equation* for the *efficient influence function* (EIF) of our estimand of interest. Without diving into what an EIF or an estimating equation is, let's accept for a moment that they will help us:
  ...
  1. **Update our initial outcome estimates** so that our estimate of the ATE is asymptotically unbiased (under certain conditions, see [*Part III, Statistical Properties*](www.khstats.com/blog/tmle/tutorial-pt3/#properties-of-tmle)).
