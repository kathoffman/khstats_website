...
[TMLE, Step-by-Step 🚶🏽️](#tmle-step-by-step)
  ...
  6. [Calculate the Standard Errors for Confidence Intervals and P-values](##step-2-calculate-the-standard-errors-for-confidence-intervals-and-p-values)
...
To learn more about the statistical properties of TMLE and the underlying theory, [*continue on to Part III*](https://khstats.com/blog/tmle/tutorial-pt3). Alternatively, [*jump back to the top*](#part-ii-the-algorithm), return to the motivation in [*Part I*](https://khstats.com/blog/tmle/tutorial/), or see the full tutorial code below.
