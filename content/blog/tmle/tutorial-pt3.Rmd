...
For example, in [*Part II*](https://khstats.com/blog/tmle/tutorial-pt2) we walked through TMLE for the Average Treatment Effect (ATE). Two frequently used alternatives to estimating the ATE are G-computation and Inverse Probability Weighting (see [*Part II, Step 1*](https://khstats.com/blog/tmle/tutorial-pt2/#step-1-estimate-the-outcome) and *references*(#resources-to-learn-more)). In general, neither yield valid standard errors unless *a-priori* specified parametric models are used, but this reliance on parametric assumptions can bias results. There are many simulation studies that show this.
