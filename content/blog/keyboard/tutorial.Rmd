---
title: "Biostatistician Builds: Mechanical Keyboard"
...
You can buy a mechanical keyboard, and to be honest, it's a much cheaper monetary and time investment. Practically, the reason to build your own keyboard is customizability. Picking out your own components provides freedom in colors, layout, feel/sound of the keys, and more. Yet the primary reason people do it, in my opinion, is that it's fun. If you enjoy DIY projects, you'll probably enjoy the challenge that comes with building your own keyboard.

Personally, I impulsively decided to build my mechanical keyboard because I was bored during quarantine after catching COVID-19 last summer. I texted my dad at 1AM to see if I could use his soldering iron, and the rest is history.
...
Picking out the components can be overwhelming! Yet it all boils down to six pieces you'll need:
...
The **PCB** is the electronic circuitry of your keyboard. You will need to choose a PCB that fits into whatever size case you've picked. One option with a PCB is whether it has RGB underglow on it, which means it has tiny lights on it that you can program to display different colors. If you want these lights to show, you'll want to have either a case or key caps which allow for the colors to shine through.
...
This is a fun choice! **Key switches** are what go below the keys to provide the majority of sound and feel. You can choose from many different brands, e.g. Cherry MX or Gateron, and types of switch feels, e.g. tactile, linear, clicky. I won't go into all the differences here, but you should know that switch colors correspond to certain sounds/feels. The color of the switch won't be seen unless you have translucent key caps. I discovered the world of [typing demo videos](https://www.youtube.com/watch?v=yXfysGqNLeE) while I was picking out key switches.
...
These were the components I used. If I were to do it again I would pick another type of switch besides Cherry Brown... they work great but they're so common and boring! I spent some time purusing builds on [reddit (r/Mechanical Keybards)](https://www.reddit.com/r/MechanicalKeyboards/) before I decided what I wanted.
...
This is what my final soldered PCB and switches looked like. Each of the keys has two small areas of flux creating an electrical conduction between the switch and the PCB. These look like small silver mounds.
