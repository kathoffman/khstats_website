...
![*All my components and tools, from left to right: a rag for touching up lubricant/flux, silicone lubricant, brass sponge for removing flux, flux (resin core solder), Hakko soldering iron, scissors, tweezers, toothpicks, switches, stabilizers (black platic feet), screws, soft feet stickers, stabilizers (metal rods), case, key caps, PCB, brass plate, and foam pad.*](/img/keyboard/IMG_9073.png)
