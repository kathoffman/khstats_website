...
In this first section, we will translate the concept of developing and optimizing an ITRs into mathematical notation.
...
We can extend either of these ideas to longitudinal settings, studies with clustering, etc. I've listed some of the resources I've read learn about optimizing ITRs below. As always, I welcome feedback and/or suggestions of additional resources I can include.
...
- This [Wang et al. paper](https://www.bios.unc.edu/~dzeng/Pub/EHROLearning1.pdf) offers a clear introduction on ITRs.
...
- Lately I've been interested in [this recent paper](https://arxiv.org/pdf/2004.14497.pdf) by Edward Kennedy. It discusses a way to evaluate the CATE using doubly robust estimation, and gives several other foundational papers in the introduction.
